...
| GET    | `/dashboard/corporation-structures/service-catalog`         | 查询服务模块目录、活动映射与当前未映射在线活动                                                                                                                                                                              | `RequireRole(admin)`        |
| PUT    | `/dashboard/corporation-structures/service-catalog`         | 校验服务模块 dogma 燃料率并保存模块目录与活动到模块映射                                                                                                                                                                    | `RequireRole(admin)`        |
