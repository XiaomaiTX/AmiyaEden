...
beforeEach(() => useSessionStore.getState().setSessionSnapshot({ isLoggedIn: true, accessToken: 'token', characterId: 1, characterName: 'Amiya', roles: ['user'], corpCapabilities: ['menu.fuxi_hall'], authList: [] }))
