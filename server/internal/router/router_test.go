...
func TestSystemBasicConfigRequiresSuperAdmin(t *testing.T) {
	...
	assertRouteStatus(t, adminRouter, http.MethodGet, "/system/sde-config/status", http.StatusForbidden)
	assertRouteStatus(t, adminRouter, http.MethodPost, "/system/sde-config/check", http.StatusForbidden)
	...
	assertRouteStatus(t, superAdminRouter, http.MethodGet, "/system/sde-config/status", http.StatusNoContent)
	assertRouteStatus(t, superAdminRouter, http.MethodPost, "/system/sde-config/check", http.StatusNoContent)
...
func newSystemBasicConfigPermissionTestRouter(roles []string) *gin.Engine {
	...
	adminConfig.GET("/sde-config/status", func(c *gin.Context) { c.Status(http.StatusNoContent) })
	adminConfig.POST("/sde-config/check", func(c *gin.Context) { c.Status(http.StatusNoContent) })
	adminConfig.POST("/sde-config/update", func(c *gin.Context) { c.Status(http.StatusNoContent) })
